...
-- -- select * from ScheduleGames where seasonid = 2205
...
--    set DivisionId = 4131
--    where seasonid = @seasonID and ScheduleNumber = 72

-- -- -- trainee 4
--  update [dbo].[ScheduleGames]
--    set DivisionId = 4132
--    where seasonid = @seasonID and ScheduleNumber = 73

-- -- -- SI boys
--  update [dbo].[ScheduleGames]
--    set DivisionId = 4133
--    where seasonid = @seasonID and ScheduleNumber = 74
